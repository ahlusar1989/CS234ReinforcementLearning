...
class BaseActor(object):
    def __init__(self, bandit):
        """
        bandit (Bandit): the target bandit to act upon.
        """
    ...
    def update_regret(self, i):
        ...
        self.regret += self.bandit.best_proba - self.bandit.probabilities[i]
...
class ThompsonSampling(BaseActor):
