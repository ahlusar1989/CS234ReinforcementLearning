...
class Agent:
    ...
    def get_reward(self, variables_cur, variables_prev):
        ...
        Parameters
        --------------
        variables_cur  : dict, dictionary containing current variables (kills, health and ammo.
        variables_prev : dict, dictionary containing previous variables (kills, health and ammo.
