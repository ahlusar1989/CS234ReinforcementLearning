...
#     parser.add_argument('--coords', type=tuple, default=(30, 300, 60, 180), metavar='COOR', help="Cropping coordinates")
    ...
    agent.train(game, total_episodes = args.total_episodes,
        pretrain = args.pretrain, frame_skip = args.frame_skip, 
        enhance = args.enhance, lr = args.lr, 
        max_tau = args.max_tau, explore_start = args.explore_start, 
        explore_stop = args.explore_stop, decay_rate = args.decay_rate, 
        gamma = args.gamma, freq = args.freq, init_zeros = args.init_zeros)
